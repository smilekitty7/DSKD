...
task = dict(
    ...
    Task1={
        'load_teacher': 0,
        'load_student': 1,
        'teacher_config': '/home/kangmx/project/incremental_mmdet/configs/deformable_detr/gfl_deformable_detr_40_r50_8x4_1x_qoqo_il.py',
...
#         'teacher_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_20_r50_8x4_1x_qoqo_hard+fg_v0/task_1_epoch_12.pth',
        'student_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_40_r50_8x4_1x_qoqo_hard_v0/task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        feats_distill = 'fg_info+fg_only', # kldv # fg_info + bg_info # 'fg_info + bg_info + sg_out' # 'fg_info + bg_info + sg_both' # 'fg_info + bg_info + meaning'
        ...
        loss_fg_feature=dict(type='KnowledgeDistillationKLDivLoss', loss_weight=0.5, T=2, reduction='sum'),
