...
task = dict(
    ...
    Task1={
        'load_teacher': 0,
        'load_student': 1,
        'teacher_config': '/home/kangmx/project/incremental_mmdet/configs/deformable_detr/gfl_deformable_detr_r50_8x4_1x_qoqo_il.py',
...
#         'teacher_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_20_r50_8x4_1x_qoqo_hard+fg_v0/task_1_epoch_12.pth',
        'student_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_40_r50_8x4_1x_qoqo_hard+memory_v0/task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        locat_distill = '',
        memory_distill = '',  # kldv + memory
        feats_distill = 'fg_info + sg_out', # fg_info + bg_info # 'fg_info + bg_info + sg_out' # 'fg_info + bg_info + sg_both' # 'fg_info + bg_info + meaning'
        ...
        loss_fg_feature=dict(type='KnowledgeDistillationKLDivLoss', loss_weight=0.1, T=1, reduction='sum'),
