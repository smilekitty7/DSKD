...
#         'student_ckpt': '/home/softlink/kmxexp/il_learning/gfl_deformable_detr_40_r50_8x4_1x_qoqo_hard+corr+decode_v1/task_1_epoch_12.pth',
        'teacher_config': '/home/zhangjp/project/incremental_mmdet/configs/deformable_detr/gfl_deformable_detr_70_r50_8x4_1x_qoqo_il.py',
        'student_ckpt': '/home/softlink/kmxexp/il_learning/gfl_deformable_detr_40_r50_8x4_1x_qoqo_hard_v000/task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(type='L1Loss', loss_weight=5.0), # 5.0
        loss_iou=dict(type='GIoULoss', loss_weight=2.0), # 2.0
        # for increment il
    ...
    train_cfg=dict(
        assigner=dict(
            ...
            cls_cost=dict(type='QualityFocalLossCost', weight=1.0),
