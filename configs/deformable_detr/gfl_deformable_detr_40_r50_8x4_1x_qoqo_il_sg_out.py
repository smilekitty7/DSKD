...
model = dict(
    ...
    bbox_head=dict(
        ...
        feats_distill = 'fg_info + sg_out', # kldv # fg_info + bg_info # 'fg_info + bg_info + sg_out' # 'fg_info + bg_info + sg_both' # 'fg_info + bg_info + meaning'
        ...
        loss_fg_feature=dict(type='KnowledgeDistillationKLDivLoss', loss_weight=0.1, T=2, reduction='sum'),
