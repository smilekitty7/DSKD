...
task = dict(
    ...
    Task1={
        'load_teacher': 0,
        'load_student': 1 ,
        'teacher_config': '/home/kangmx/project/incremental_mmdet/configs/deformable_detr/gfl_deformable_detr_r50_8x4_1x_qoqo_il_local.py',
        'teacher_ckpt': '/home/softlink/experiments/il_learning/gfl_deformable_detr_20_1/40_task_1_epoch_12.pth',
        'student_ckpt': '/home/softlink/experiments/il_learning/gfl_deformable_detr_20_1/40_task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        feats_distill = 'corr', # fg_info + bg_info
        ...
        loss_memory=dict(type='KnowledgeDistillationKLDivLoss', loss_weight=1, T=2, reduction='sum'),
...
data = dict(
    samples_per_gpu=4, workers_per_gpu=2, cat_split_load=cat_split_load,
    train=dict(test_mode=False, catsplit=catsplit, catload=catload, catpred='prev-cur', catwise=True, imgpercent=1),
    val=dict(test_mode=True, catsplit=catsplit, catload=catload, catpred='only-cur', catwise=True, imgpercent=1),
