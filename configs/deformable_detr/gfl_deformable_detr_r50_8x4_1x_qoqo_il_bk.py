...
#         'teacher_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_20_r50_8x4_1x_qoqo_v0/epoch_11.pth',
#         'student_ckpt': '/wlsys/kangmx/experiments/il_learning/gfl_deformable_detr_20_r50_8x4_1x_qoqo_v0/epoch_11.pth',
    },
)
...
catsplit, catload = (20, 20, 20, 20), (0, 1, 0, 0)
...
data = dict(
    ...
    val=dict(test_mode=True, catsplit=catsplit, catload=catload, catpred='only-cur', catwise=True, imgpercent=1), # only-cur
