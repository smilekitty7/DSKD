...
task = dict(
    ...
    Task1={
        'load_teacher': 1,
        'load_student': 1,
        'teacher_config': '/home/kangmx/project/incremental_mmdet/configs/yolof/yolof_resnet_qoqo_il.py',
        'teacher_ckpt': '/home/softlink/experiments/yolof/yolof-r18-stst-qoqo-il80-v4/epoch_12.pth',
        'student_ckpt': '/home/softlink/experiments/yolof/yolof-r18-stst-qoqo-il80-v4/epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_ld=dict(type='KnowledgeDistillationKLDivLoss', loss_weight=0.25, T=10, reduction='mean'),
