...
def parse_args():
    ...
    parser.add_argument('--checkpoint',
                        ...
                        # default='/home/softlink/zhjpexp/yolox-r18-stst-qoqo/epoch_5.pth',
                        # default='/home/softlink/experiments/wrxt-faster-r18-stst/epoch_12.pth',
                        help='checkpoint file')
    parser.add_argument('--show', default=1, action='store_true', help='show results')
...
def main():
    ...
    print('\n===  model archtecture start  ===')
    print(model)
    print('===  model archtecture end ===\n')
