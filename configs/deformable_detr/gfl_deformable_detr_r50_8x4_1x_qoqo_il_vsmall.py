...
task = dict(
    ...
    Task1={
        'load_teacher': 0,
        'load_student': 1 ,
        'teacher_config': '/home/kangmx/project/incremental_mmdet/configs/deformable_detr/gfl_deformable_detr_r50_8x4_1x_qoqo_il_vsmall.py',
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_corr=dict(type='MSELoss', loss_weight=10, reduction='mean'),
    ),
...
data = dict(
    samples_per_gpu=2, workers_per_gpu=1, cat_split_load=cat_split_load,
