...
task = dict(
    ...
    Task1={
        ...
        # 'student_ckpt': '/home/zhangjp/softlink/experiments/yoloy-r18-stst-qoqo-il20-v8-c2iou-b16/task1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        cates_distill='',   # hard + hardsoft + normsoft + soft
...
runner = dict(type='EpochBasedRunner', max_epochs=12, max_tasks=task_nums, save_teacher=False)
